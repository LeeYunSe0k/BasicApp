...
//  QuotesGenerator
//
//  Created by 이윤석 on 2022/05/08.
//

import UIKit

class ViewController: UIViewController {
    @IBOutlet weak var quoteLavel: UILabel!
    ...
    @IBAction func tapQuoteGeneratorButton(_ sender: Any) {
        let random = Int(arc4random_uniform(5)) // 0~4사이의 난수를 생성시킴
        let quote = quotes[random]
        self.quoteLavel.text = quote.contents
